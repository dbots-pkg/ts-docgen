...
function parseClass(element) {
    ...
    var meta = documentation_1.parseMeta(element);
    return {
        name: element.name == 'default' ? path_1.default.parse((meta === null || meta === void 0 ? void 0 : meta.file) || 'default').name : element.name,
