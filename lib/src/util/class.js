...
function parseClassMethod(element) {
    ...
    return {
        ...
        emits: (_l = (_k = signature.comment) === null || _k === void 0 ? void 0 : _k.tags) === null || _l === void 0 ? void 0 : _l.filter(function (t) { return t.tag == 'emits'; }).map(function (t) { return t.text; }),
