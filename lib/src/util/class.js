...
function parseClass(element) {
    ...
    return {
        ...
        access: (element.flags.isPrivate || ((_j = (_h = element.comment) === null || _h === void 0 ? void 0 : _h.tags) === null || _j === void 0 ? void 0 : _j.some(function (t) { return t.tag == 'private'; }))) ? 'private' : undefined,
...
function parseClassProp(element) {
    ...
    return {
        ...
        access: (element.flags.isPrivate || ((_e = (_d = element.comment) === null || _d === void 0 ? void 0 : _d.tags) === null || _e === void 0 ? void 0 : _e.some(function (t) { return t.tag == 'private'; }))) ? 'private' : undefined,
...
function parseClassMethod(element) {
    ...
    return {
        ...
        scope: element.flags.isStatic ? 'static' : undefined,
        access: (element.flags.isPrivate || ((_e = (_d = signature.comment) === null || _d === void 0 ? void 0 : _d.tags) === null || _e === void 0 ? void 0 : _e.some(function (t) { return t.tag == 'private'; }))) ? 'private' : undefined,
